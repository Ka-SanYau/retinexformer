...
from basicsr.data.util import bgr2ycbcr
# bgr2ycbcr
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt', type=str, default='/home/qc-lab/research/datasets/IR_dataset/eval/high', help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', type=str, default='/media/qc-lab/back_up/1/LLIE/DiffBIR/results/LLIE', help='Path to restored images')
